...
namespace ComputerPlus
{
    internal class ArrestReportDataCode : GwenForm
    {
        ...
        {
            if (Configs.OfficerName.Contains(" "))
            {
                string[] oName = Configs.OfficerName.Split(' ');
                ValueBox1.Text = oName[0];
                ValueBox2.Text = oName[1];
            }
            ValueBox3.Text = Configs.OfficerNumber;
            ValueBox4.Text = Configs.RandomNumber.r.Next(200, 3000).ToString();
        ...
        private void AutoFillVehicle()
        {
            if (Functions.IsPlayerPerformingPullover() == true)
            {
                ...
                for (int i = 0; i < vehs.Length; i++)
                {
                    ...
                    ValueBox6.Text = Configs.RandomNumber.r.Next(300000, 950000).ToString();
        ...
        private string GetRandomAddress()
        {
            ...
            int PerpNumber = Configs.RandomNumber.r.Next(100, 1700);
